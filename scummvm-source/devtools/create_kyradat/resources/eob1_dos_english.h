...
// 95 EN item names (extracted from EOBDATA6.PAK/ITEM.DAT)
static const char *const kEoB1ItemNamesDOSEnglish[95] = {
	"Mouse Pointer",
	"",
	"Leather armor",
	"Robe",
...
static const StringListProvider kEoB1ItemNamesDOSEnglishProvider = { ARRAYSIZE(kEoB1ItemNamesDOSEnglish), kEoB1ItemNamesDOSEnglish };
